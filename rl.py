...
def outcome_math_reward_func(prompts, completions, target_numbers, **kwargs):
    """
...
def main():
    # Путь исправлен на ту модель, которую мы только что оценивали
    model_id = "../base_model/final"
    dataset_path = "train_id.jsonl"
    output_dir = "../grpo_game24_outcome_v4"
...
'''
[test_id.jsonl] Оценка точности...
Инференс test_id.jsonl: 100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 248/248 [05:58<00:00,  1.44s/it]
--> Точность на test_id.jsonl: 15.73% (39/248)

[test_ood.jsonl] Оценка точности...
Инференс test_ood.jsonl: 100%|████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 250/250 [06:26<00:00,  1.55s/it]
--> Точность на test_ood.jsonl: 8.80% (22/250)

Это уже обученный RL. Кажется, мы то ли недообучили, то ли я не знаю, что не так. Почему ID поднялось, а OOD поднялось? Я конечно не знаю что будет с СФТ... Может он вообще скатится в 2%, но мне не очень нравится, что в статье RL поднялся на пару процентов, а у нас на те же пару процентов наоборот опустился...[test_id.jsonl] Оценка точности...
Инференс test_id.jsonl: 100%|█████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 248/248 [05:58<00:00,  1.44s/it]
--> Точность на test_id.jsonl: 15.73% (39/248)
...
Это уже обученный RL. Кажется, мы то ли недообучили, то ли я не знаю, что не так. Почему ID поднялось, а OOD поднялось? Я конечно не знаю что будет с СФТ... Может он вообще скатится в 2%, но мне не очень нравится, что в статье RL поднялся на пару процентов, а у нас на те же пару процентов наоборот опустился...
'''